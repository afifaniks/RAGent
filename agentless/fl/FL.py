...
The possible location outputs should be either "class", "function" or "line". You MUST provide the exact numeric line numbers as provided in the code.
You must only provide locations (full_path, class, function, or line numbers) that appear in the provided file snippet(s). DO NOT ignore these information.
Do not reference or guess other files. If you cannot find the location in the given snippet, do not guess or suggest files not provided.

STRICTLY follow the provided example output format:
### Example output:
```
full_path1/file1.py
line: 10
