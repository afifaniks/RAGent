# Main Implementation: https://github.com/OpenAutoCoder/Agentless/blob/main/get_repo_structure/get_repo_structure.py
...
def get_project_structure_from_scratch(
    repo_name, commit_id, instance_id, repo_playground, cleanup=True
):
    ...
    # clean up
    if cleanup:
        print(f"Cleaning up the playground at {repo_playground}...")
        subprocess.run(
